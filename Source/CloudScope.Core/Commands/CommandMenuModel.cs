...
public static class CommandMenu
{
    ...
    [
        CommandMenuEntry.Submenu("File",
            ...
            CommandMenuEntry.Separator,
            CommandMenuEntry.Action("Load polylines...", "LOADPOLYLINES"),
            CommandMenuEntry.Action("Save polylines...", "SAVEPOLYLINES"),
            CommandMenuEntry.Separator,
        ...
        CommandMenuEntry.Submenu("Edit",
            ...
            CommandMenuEntry.Separator,
            CommandMenuEntry.Action("Polyline...", "PLINE"),
            CommandMenuEntry.Action("3D polyline...", "3DPOLY"),
            CommandMenuEntry.Action("Edit polyline...", "PEDIT"),
            CommandMenuEntry.Separator,
