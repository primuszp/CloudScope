...
namespace CloudScope.Platform.Metal.Rendering
{
    internal sealed class NullPointCloudRenderer : IPointCloudRenderer
    {
        ...
        public int Render(IRenderFrameData frameData, ref Matrix4 view, ref Matrix4 projection, float pointSize, double halfViewSize, float cloudRadius) => 0;
        public void Dispose() { }
    }
    ...
    {
        public void Initialize() { }
        public void RenderPivotIndicator(IRenderFrameData frameData, ref Matrix4 view, ref Matrix4 proj, OrbitCamera camera, Vector3 pivot, float fade, float flash) { }
